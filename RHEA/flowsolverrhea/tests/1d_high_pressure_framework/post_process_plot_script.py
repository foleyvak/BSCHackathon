...
plt.rc( 'font', size = 20 )
plt.rcParams['text.latex.preamble'] = r'\usepackage{amsmath}\usepackage{amssymb}\usepackage{color}'
...
cp_data    = data_file['c_p'][0,0,:];   cp_data    = np.asarray( cp_data.flatten() )
cv_data    = data_file['c_v'][0,0,:];   cv_data    = np.asarray( cv_data.flatten() )
s_data     = data_file['s'][0,0,:];     s_data     = np.asarray( s_data.flatten() )
...
plt.plot( T_data, e_data/1.0e3, linestyle = '--', color = 'firebrick', label = r'$\textrm{RHEA}$' )
...
### Plot dynamic viscosity vs. temperature
...
legend = plt.legend( shadow = False, fancybox = False, frameon = False, loc='upper right' )
plt.tick_params( axis = 'both', pad = 7.5 )
plt.savefig( 'dynamic_viscosity_vs_temperature.eps', format = 'eps', bbox_inches = 'tight' )
...
# Read & Plot data
plt.scatter( T_nist, P_nist, s = 25, facecolors = 'none', edgecolors = 'black', label = r'$\textrm{NIST}$' )
plt.plot( T_data, P_data/1.0e6, linestyle = '--', color = 'firebrick', label = r'$\textrm{RHEA}$' )
...
plt.xlabel( r'$T \thinspace \textrm{[K]}$' )
plt.ylim( 3.9, 4.1 )
plt.yticks( np.arange( 3.9, 4.11, 0.05 ) )
#plt.yscale( 'log' )
plt.ylabel( r'$P \thinspace \textrm{[MPa]}$' )
legend = plt.legend( shadow = False, fancybox = False, frameon = False, loc='upper right' )
plt.tick_params( axis = 'both', pad = 7.5 )
plt.savefig( 'pressure_vs_temperature.eps', format = 'eps', bbox_inches = 'tight' )


### Plot isobaric specific heat vs. temperature

# Clear plot
plt.clf()

# Read & Plot data
plt.scatter( T_nist, cp_nist, s = 25, facecolors = 'none', edgecolors = 'black', label = r'$\textrm{NIST}$' )
plt.plot( T_data, cp_data/1.0e3, linestyle = '--', color = 'firebrick', label = r'$\textrm{RHEA}$' )
...
#plt.yscale( 'log' )
plt.ylabel( r'$c_p \thinspace \textrm{[kJ/(kg}\cdot\textrm{K)]}$' )
legend = plt.legend( shadow = False, fancybox = False, frameon = False, loc='upper right' )
plt.tick_params( axis = 'both', pad = 7.5 )
plt.savefig( 'isobaric_specific_heat_vs_temperature.eps', format = 'eps', bbox_inches = 'tight' )


### Plot isochoric specific heat vs. temperature

# Clear plot
plt.clf()

# Read & Plot data
plt.scatter( T_nist, cv_nist, s = 25, facecolors = 'none', edgecolors = 'black', label = r'$\textrm{NIST}$' )
plt.plot( T_data, cv_data/1.0e3, linestyle = '--', color = 'firebrick', label = r'$\textrm{RHEA}$' )
...
plt.xlabel( r'$T \thinspace \textrm{[K]}$' )
plt.ylim( -1.0, 1.5 )
plt.yticks( np.arange( -1.0, 1.6, 0.5 ) )
#plt.yscale( 'log' )
plt.ylabel( r'$c_v \thinspace \textrm{[kJ/(kg}\cdot\textrm{K)]}$' )
legend = plt.legend( shadow = False, fancybox = False, frameon = False, loc='upper right' )
plt.tick_params( axis = 'both', pad = 7.5 )
plt.savefig( 'isochoric_specific_heat_vs_temperature.eps', format = 'eps', bbox_inches = 'tight' )
...
# Read & Plot data
plt.scatter( T_nist, s_nist, s = 25, facecolors = 'none', edgecolors = 'black', label = r'$\textrm{NIST}$' )
plt.plot( T_data, s_data/1.0e3, linestyle = '--', color = 'firebrick', label = r'$\textrm{RHEA}$' )
...
#plt.yscale( 'log' )
plt.ylabel( r'$s \thinspace \textrm{[kJ/(kg}\cdot\textrm{K)]}$' )
legend = plt.legend( shadow = False, fancybox = False, frameon = False, loc='lower right' )
plt.tick_params( axis = 'both', pad = 7.5 )
plt.savefig( 'entropy_vs_temperature.eps', format = 'eps', bbox_inches = 'tight' )
